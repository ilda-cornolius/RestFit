...
android {
    ...
    buildTypes {
        release {
            ...
            // Minify was breaking Google Credential Manager on Play installs (debug Sign-In worked).
            // Keep rules alone were not enough on Skip/Credential Manager; re-enable later with care.
